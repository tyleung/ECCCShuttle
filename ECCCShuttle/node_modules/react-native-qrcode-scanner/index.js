...
export default class QRCodeScanner extends Component {  
  static propTypes = {
    ...
    showCustomMarker: PropTypes.bool,
    ...
    cameraOverlay: PropTypes.oneOfType([
      PropTypes.element,
      PropTypes.string,
    ])
  }
  ...
  _renderCameraOverlay() {
    if (this.props.cameraOverlay) {
      return this.props.cameraOverlay;
    }
    return null;
  }
  ...
  _renderCameraMarker() {
    ...
    if (this.props.showCustomMarker) {
      return (
